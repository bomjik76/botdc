        ...
        class SearchModal(discord.ui.Modal, title="Поиск песни"):
            ...
            async def on_submit(self, interaction: discord.Interaction):
                ...
                try:
                    ...
                    view = SearchResultsView(search_results, self.player, self.search_query.value)
...
class SearchResultsView(discord.ui.View):
    ...
    async def select_track(self, interaction, idx):
        ...
        try:
            # Check bot permissions
            if not interaction.user.voice.channel.permissions_for(interaction.guild.me).connect:
                await interaction.followup.send("I don't have permission to join your voice channel!", ephemeral=True)
                return
